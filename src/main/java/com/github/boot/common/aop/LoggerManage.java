...
//    @Pointcut("execution(* com.github.boot..*.*(..))")
//    public void webLog(){}

    @Before("within(com.github.boot..*) && @annotation(loggerAnnotation)")
...
//        log.info("方法路径:"+joinPoint.getSignature().toString());
    ...
    @AfterReturning("within(com.github.boot..*) && @annotation(loggerAnnotation)")
...
//    @AfterThrowing(pointcut = "within(com.github.boot..*) && @annotation(loggerAnnotation)", throwing = "e")
